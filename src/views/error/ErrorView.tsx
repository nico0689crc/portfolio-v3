...
const dictionary = {
  en: {
    ...
    "description": "Oops! It seems something went wrong while loading the page. Please try refreshing the page or come back later. If the issue persists, feel free to contact us for assistance.",
  ...
  es: {
    ...
    "description": "¡Ups! Parece que algo salió mal al cargar la página. Intenta actualizar la página o vuelve más tarde. Si el problema persiste, no dudes en contactarnos para obtener ayuda.",
