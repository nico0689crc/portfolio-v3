...
const AboutMeHeaderSubtitle = ({ subtitle }: { subtitle: string }) => (
  <Typography variant="h5" component="p" className="about-me-header__subtitle">
    {subtitle}
  </Typography>
);
...
const AboutMeHeader = ({ dictionary }: DictionaryType) => (
  ...
  >
    <AboutMeHeaderTitle title={dictionary.pages.home.sections.about.title} />
    <AboutMeHeaderSubtitle subtitle={dictionary.pages.home.sections.about.know_me_more} />
  </Box>
);
