  ...
  },
  {
    information: {
      ...
      es: {
        title: 'Portafolio',
        description:
          'Este proyecto de portafolio sirve como mi sitio web personal, mostrando mis habilidades, proyectos y trayectoria profesional. Construido con NextJS y MUI, utiliza prácticas modernas de desarrollo web como renderizado del lado del servidor (SSR) y diseño responsivo para garantizar una experiencia de usuario óptima en todos los dispositivos.',
      },
    },
    tags: [
      'NextJS',
  ...
  },
  {
    information: {
      ...
      es: {
        ...
        description:
          'El proyecto de la Biblioteca de la Ciudad de Fremantle fue desarrollado como parte de mi curso de Diploma en Tecnología de la Información (Desarrollo Web). Muestra las mejores prácticas en desarrollo web, incluyendo optimización SEO, diseño responsivo y principios de UX/UI centrados en el usuario. El proyecto también incluye un diseño detallado en Figma para complementar el proceso de desarrollo.',
      },
    },
    tags: [
      'HTML',
